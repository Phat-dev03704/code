...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description='Test Clarke-Wright với nhiều datasets',
...
Ví dụ sử dụng:
  ...
  python test_all_datasets.py --category C1 R1
  
  # Test với giới hạn
  python test_all_datasets.py --limit 5
  
  # Tùy chỉnh tham số
  python test_all_datasets.py --category C1 --capacity 250
        """
    )
...
def test_with_params(categories_filter=None, limit=None, capacity=200, max_vehicles=25):
    ...
    print("="*100)
    print("TEST CLARKE-WRIGHT SAVINGS ALGORITHM")
    print("="*100)
    ...
    for category, files in categories.items():
        ...
        for dataset_name in files:
            ...
            try:
                solver = ClarkeWrightVRPTWSolver(str(dataset_path), capacity, max_vehicles)
                result = solver.solve()
